(function() {
  var icons, path, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
    ...
    return {
      build: function(fn) {
        ...
        if (icons != null ? (_ref9 = icons.ios) != null ? _ref9.icon60x2 : void 0 : void 0) {
          return grunt.file.copy(icons.ios.icon60x2, path.join(res, 'icon-60@2x.png'), {
            encoding: null
          });
        }
      }
  ...
  if (icons != null ? (_ref = icons.ios) != null ? _ref.icon60x3 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon60x3, path.join(res, 'icon-60@3x.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref1 = icons.ios) != null ? _ref1.icon72 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon72, path.join(res, 'icon-72.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref2 = icons.ios) != null ? _ref2.icon72x2 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon72x2, path.join(res, 'icon-72@2x.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref3 = icons.ios) != null ? _ref3.icon76 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon76, path.join(res, 'icon-76.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref4 = icons.ios) != null ? _ref4.icon76x2 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon76x2, path.join(res, 'icon-76@2x.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref5 = icons.ios) != null ? _ref5.icon512 : void 0 : void 0) {
    grunt.file.copy(icons.ios.icon512, path.join(res, 'icon-512.png'), {
      encoding: null
    });
  }

  if (icons != null ? (_ref6 = icons.ios) != null ? _ref6.icon512x2 : void 0 : void 0) {
